...
class LineChartSample3 extends StatefulWidget {
  LineChartSample3({
    ...
    Color? tooltipTextColor,
        ...
        indicatorLineColor =
            indicatorLineColor ?? const Color.fromARGB(255, 250, 197, 23).withOpacity(0.2),
        indicatorTouchedLineColor =
            indicatorTouchedLineColor ?? const Color.fromARGB(255, 250, 197, 23),
        indicatorSpotStrokeColor = indicatorSpotStrokeColor ??
            const Color.fromARGB(255, 250, 197, 23).withOpacity(0.5),
        indicatorTouchedSpotStrokeColor =
            indicatorTouchedSpotStrokeColor ?? const Color.fromARGB(255, 250, 197, 23),
        bottomTextColor =
            bottomTextColor ?? const Color.fromARGB(255, 250, 197, 23).withOpacity(0.2),
        bottomTouchedTextColor =
            bottomTouchedTextColor ?? Color.fromARGB(255, 250, 197, 23),
        averageLineColor =
  ...
  List<String> get weekDays =>
      const ['Jan', 'Feb', 'March', 'April', 'May', 'June', 'July'];

  List<double> get yValues => const [250, 100, 50, 200, 150, 250, 300];
